...
- Static routes: 26
- Category routes: 6
- Product detail routes discovered: 142
...
- Desktop visual audited routes: 196
- Mobile visual audited routes: 196
...
### P1
- Missing route-level metadata on 26 indexable static pages
...
### P2
- Broken product images detected on 3 desktop route checks
