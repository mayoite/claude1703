        ...
        <div className="mt-4 grid gap-4 lg:grid-cols-2 xl:grid-cols-3">
          {visualReferences.map((reference) => (
            ...
            >
              ...
              {reference.image ? (
                <div className="relative mt-4 overflow-hidden rounded-2xl border border-soft bg-hover">
                  <Image
                    src={reference.image}
                    alt={reference.title}
                    width={1280}
              ...
              {"imageSecondary" in reference && reference.imageSecondary ? (
                <div className="relative mt-3 overflow-hidden rounded-2xl border border-soft bg-hover">
                  <Image
              ...
              <div className="mt-4 rounded-2xl border border-soft bg-hover px-3 py-2.5">
        ...
        <div className="mt-8 rounded-[1.4rem] border border-soft bg-panel p-4 shadow-sm">
          ...
          <div className="mt-4 grid gap-3 lg:grid-cols-2">
            {secondaryReferences.map((reference) => (
              <article
                key={reference.title}
                className="rounded-2xl border border-soft bg-hover p-3"
              >
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <p className="text-[11px] font-medium text-subtle">{reference.badge}</p>
                ...
                <div className="mt-4 rounded-2xl border border-soft bg-panel px-3 py-2.5">
                  <p className="text-[11px] font-medium text-subtle">Local path</p>
                  <p className="mt-1 break-all font-mono text-xs text-body">{reference.path}</p>
                </div>
                {"actionHref" in reference && reference.actionHref ? (
