...
- Note: Catalog source-gap triage block complete; continuing into next frontend improvement lane.
## Next Chat Prompt
```text
...
## Operator Note
Current recovery goal: keep the remaining catalog backlog truthful while aligning live UX to real repo capabilities. The downloads route now behaves as a request-based Resource Desk, fluid-x remains the only legacy-slug exception, Luna remains the only unresolved media blocker, and missing_documents is still a verified source-gap backlog.
