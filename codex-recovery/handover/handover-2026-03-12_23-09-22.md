...
- Note: Finished block. Decisions/checklist/plan aligned; no open decisions; next execution item is GraphQL alias-table exposure fix plus parity recheck.
## Next Chat Prompt
```text
...
## Operator Note
Closed all open decision items; GraphQL alias exposure gap treated as accepted transition constraint with SQL rescue compensating control.
