...
- Note: Trust wave 1 verified; CURRENT-PLAN now mirrors NEXT-PLAN as a handover-only pointer
## Next Chat Prompt
```text
Read /e:/new-repo-20260306-235837/codex-recovery/handover/latest-handover.md first.
Then read /e:/new-repo-20260306-235837/codex-recovery/handover/CURRENT-RULES.md, /e:/new-repo-20260306-235837/codex-recovery/handover/CURRENT-PLAN.md, and /e:/new-repo-20260306-235837/codex-recovery/handover/CURRENT-CHECKLIST.md.
Then read /e:/new-repo-20260306-235837/codex-recovery/README.md, /e:/new-repo-20260306-235837/codex-recovery/MASTER-OBJECTIVE.md, /e:/new-repo-20260306-235837/codex-recovery/RECOVERY-ROADMAP.md, /e:/new-repo-20260306-235837/codex-recovery/RECOVERY-CHECKLIST.md, /e:/new-repo-20260306-235837/codex-recovery/DECISIONS.md, /e:/new-repo-20260306-235837/codex-recovery/HOLDS.md, /e:/new-repo-20260306-235837/codex-recovery/NEXT-PLAN.md, and /e:/new-repo-20260306-235837/codex-recovery/latest.md, then continue exactly from the recorded recovery state. Do not delete any file. Only move, archive, verify, and update the recovery docs.
```
...
## Operator Note
Current recovery goal: continue the world-class frontend lane from a closed catalog-truth block. The missing_documents policy is now locked as an active audit requirement, the Resource Desk UX is aligned, fluid-x remains the only legacy-slug exception, and Luna remains the only unresolved media blocker.
...
- The current document-source evidence and next-decision options are captured in `codex-recovery/DOCUMENT-SOURCE-GAP.md`.
...
- [x] Finalize whether `missing_documents` remains an audit issue or becomes a separately tracked content backlog
- [x] Update `NEXT-PLAN.md`, `DECISIONS.md`, `RECOVERY-CHECKLIST.md`, and `LATEST.md`
- [x] Generate a fresh recovery snapshot
...
- [x] Document-source gap is inventory-complete and recorded without ambiguity.
- [x] Build verification passes after any audit/doc updates.
- [x] Recovery docs capture the bounded catalog backlog state without ambiguity.
...
- Move into the next world-class frontend improvement lane while keeping `missing_documents` visible as an active content-ingestion requirement and `Luna` explicitly deferred until repo-backed media evidence appears.
