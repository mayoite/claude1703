...
## Operator Note
Category discovery wave 1 is build-verified. Next active step: improve filter grouping, active-filter visibility, and mobile drawer clarity on /products/[category].
