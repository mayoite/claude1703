...
## Operator Note
Block closeout: typography/color cleanup partially normalized into theme-tokens, typography.css, and color-contrast.css; footer duplicate links fixed; about/sustainability/shared sections moved toward token scheme; font-mono removed; build verification currently blocked by stale .next/dev/types artifact, lint passes.
