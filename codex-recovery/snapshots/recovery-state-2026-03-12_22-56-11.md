...
## Operator Note
Resumed block completed: parity baseline + fallback contract lock + sync verification hardening done; next explicit step is legacy runtime dependency review.
