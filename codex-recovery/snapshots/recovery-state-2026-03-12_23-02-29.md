...
## Operator Note
Week 1 closeout deferred with reason: Nhost GraphQL alias-table exposure gap; next explicit step is GraphQL alias exposure fix and parity recheck.
...
- [ ] Generate fresh recovery snapshot
