...
## Operator Note
Verified 42-file unused move wave, excluded unused from tsconfig build scope, and confirmed npm run build passes; remaining deletions outside unused are older dirty state.
...
- Reconfirm required root config files remain after the recovery move wave.
- Reconfirm active source folders remain intact while leaving live routes and reachable components untouched.
