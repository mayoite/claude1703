...
## Operator Note
Recorded route truth across app pages and API routes, marking public/internal/preview/redirect/uncertain ownership conservatively; next block moves to duplicate-system review while keeping the 42-file unused wave separate from the 52-path oando_website deletion cluster.
...
- Start Phase 14 duplicate-system review with the header, footer, configurator, process-section, cookie-consent, and bot/assistant families.
- Preserve the current duplicate-family holds while ownership is being mapped.
- Avoid any new source moves until duplicate-family notes exist.
