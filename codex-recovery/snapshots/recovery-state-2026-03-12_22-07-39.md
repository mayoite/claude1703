...
## Operator Note
Added PX basics first sequencing to the active Week 1 platform plan.
...
# Week 1 / Platform Integrity / PX Basics First / Current 45-Minute Block

Execution rule for this block: keep PX basics first before any wider platform-overhaul work.
...
- Keep PX basics first: live parity baseline, internal fallback-source contract, business-stats SQL rescue design, and mirror verification definition come before broader overhaul follow-ons.
