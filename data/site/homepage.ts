...
export const HOMEPAGE_TRUST_CONTENT = {
  ...
  logos: [
    { name: "Titan", src: "/ClientLogos/Titan.webp" },
    { name: "L&T", src: "/ClientLogos/LandT.webp" },
    { name: "JSW", src: "/ClientLogos/JSW.webp" },
    { name: "Tata Motors", src: "/ClientLogos/TataMotors.webp" },
    { name: "Maruti Suzuki", src: "/ClientLogos/MarutiSuzuki.webp" },
    { name: "HDFC", src: "/ClientLogos/HDFCLogo.webp" },
  ],
